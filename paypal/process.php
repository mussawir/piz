 ...
 if($_POST) //Post Data received from product list page.
 {
	...
	$padata = 	'&METHOD=SetExpressCheckout'.
				...
				*/
				...
				'&LOGOIMG=http://netefct.com/dev/images/logo.png'. //site logo
				...
				*/
				...
				if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) 
				{
					...
					*/
					...
					//print_r($httpParsedResponseAr);
					//echo '</pre>';
                header('location: ' . SYSTEM_PATH.'/index/page-order-confirmation/response/'. $httpParsedResponseAr['ACK']);

                /* foreach($httpParsedResponseAr as $res){
                		echo '<pre>';
                print_r($res);
                		echo '<pre>';
                					}*/
				...
				/*	echo '<div style="color:red"><b>GetTransactionDetails failed:</b>'.urldecode($httpParsedResponseAr["L_LONGMESSAGE0"]).'</div>';
					...
					print_r($httpParsedResponseAr);
					echo '</pre>';*/
                header('location: ' . SYSTEM_PATH.'/index/payment-failed/response/'. $httpParsedResponseAr['ACK']);
